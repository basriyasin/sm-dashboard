...
const Sidebar = (props) => {
    const createMenu = (menu, active) => {
        let classes = []
        if (menu.active) classes.push('nav-active')
        if (menu.sub) classes.push('nav-parent')
        if (menu.active && menu.sub) classes.push('nav-expanded')
            ...
            <li className={classes.join(' ')}>
                ...
                {menu.sub &&
                    <ul class="nav nav-children">
                        {menu.sub.map((item, index) => createMenu(item, menu.active))}
                    </ul>
                }
            </li>
        )
                        ...
                        <ul class="nav nav-main">
                            ...
                            <li class="nav-parent">
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li>
                                        <a
                                            class="nav-link"
                                            href="ecommerce-customers-form.html"
                                        >
                                            Customers Form
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-parent">
                                        <a class="nav-link" href="#">
                                            ...
                                            <span
                                                class="mega-sub-nav-toggle toggled float-end"
                                                data-toggle="collapse"
                                                data-target=".mega-sub-nav-sub-menu-2"
                                            ></span>
                                        </a>
                                        <ul class="nav nav-children">
                                            <li>
                                    ...
                                    <li class="nav-parent">
                                        <a class="nav-link" href="#">
                                            ...
                                            <span
                                                class="mega-sub-nav-toggle toggled float-end"
                                                data-toggle="collapse"
                                                data-target=".mega-sub-nav-sub-menu-3"
                                            ></span>
                                        </a>
                                        <ul class="nav nav-children">
                                            <li>
                            ...
                            <li class="nav-parent">
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li>
                                        <a
                                            class="nav-link"
                                            href="maps-google-maps-builder.html"
                                        >
                                            Map Builder
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <span
                                    >Front-End
                                        <em class="not-included">(Not Included)</em></span
                                    >
                                </a>
                            </li>
                            <li>
